...
4.	Activate the plugin again through the 'Plugins' menu in WordPress
5.	Go to "Options"->"obsocialbookmarker" and you will have choice to do following two things same as before
		a.	Tick the position where you want to show the Bookmarks.
		b.	Tick the Bookmarks which you want to show.
